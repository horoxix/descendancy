...
using descendancy.Tiles;
using GoRogue.DiceNotation;
using Microsoft.Xna.Framework;
using System.Text;

namespace descendancy.Commands
{
    ...
    public class CommandManager
    {
        ...
        public void Attack(Actor attacker, Actor defender)
        {
            ...
            DescendancyGame.UIManager.MessageLog.Add(attackMessage.ToString());
            if (!string.IsNullOrWhiteSpace(defenseMessage.ToString()))
            {
                DescendancyGame.UIManager.MessageLog.Add(defenseMessage.ToString());
            }
        ...
        private static void ResolveDamage(Actor defender, int damage)
        {
            if (damage > 0)
            {
                ...
                DescendancyGame.UIManager.MessageLog.Add($" {defender.Name} was hit for {damage} damage");
            ...
            {
                DescendancyGame.UIManager.MessageLog.Add($"{defender.Name} blocked all damage!");
            }
        }
        ...
        private static void ResolveDeath(Actor defender)
        {
            ...
            if (defender.Inventory.Count > 0)
            {
                ...
                foreach (Item item in defender.Inventory)
                {
                    ...
                    DescendancyGame.UIManager.MapScreen.Map.AddEntity(item);
            ...
            // actor goes bye-bye
            DescendancyGame.UIManager.MapScreen.Map.RemoveEntity(defender);

            // Now show the deathMessage in the messagelog
            DescendancyGame.UIManager.MessageLog.Add(deathMessage.ToString());
        }
        ...
        public void Pickup(Actor actor, Item item)
        {
            ...
            DescendancyGame.UIManager.MessageLog.Add($"{actor.Name} picked up {item.Name}");
            DescendancyGame.UIManager.MapScreen.Map.RemoveEntity(item);
        }
        ...
        public void UseDoor(Actor actor, TileDoor door)
        {
            ...
            {
                door.Open();
                DescendancyGame.UIManager.MessageLog.Add($"{actor.Name} opened a {door.Name}");
            }
        }
    }
}
